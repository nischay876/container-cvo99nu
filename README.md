...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cvo99nu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cvo99nu.containers.anotherwebservice.com/
...
```
git clone git@github.com:nischay876/container-cvo99nu.git
cd container-cvo99nu
```
...
```
docker attach container-cvo99nu
```
